...
use Xsolla\SDK\Webhook\Message\PaymentAccountAddMessage;

class PaymentAccountAddMessageTest extends TestCase
{
    protected $request = [
    ...
    {
        $message = new PaymentAccountAddMessage($this->request);
