...
use Xsolla\SDK\Webhook\Message\PartialRefundMessage;

class PartialRefundMessageTest extends TestCase
{
    protected $request = [
    ...
    {
        $message = new PartialRefundMessage($this->request);
    ...
    public function testEmptyFields()
    {
        ...
        $message = new PartialRefundMessage($requestCopy);
