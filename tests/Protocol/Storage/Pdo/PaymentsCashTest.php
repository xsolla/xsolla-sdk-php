...
class PaymentsCashTest extends PaymentsTest
{

    /**
     * @var \Xsolla\SDK\Protocol\Storage\PaymentsCashInterface
     */
    ...
    {
        parent::setUp();
        $this->paymentStorage = new \Xsolla\SDK\Protocol\Storage\Pdo\PaymentsCash($this->dbMock);
